try {
    ...
    ThemeToggleBtn123.addEventListener('click', () => {
        ...
        if (DocElement123.getAttribute('data-theme') === 'dark') {
            DocElement123.setAttribute('data-theme', 'light');
            ThemeToggleBtn123.innerHTML = '☾';
        } else {
            DocElement123.setAttribute('data-theme', 'dark');
            ThemeToggleBtn123.innerHTML = '☼';
        }
    });
    ...
    LangToggleBtn123.addEventListener('click', () => {
        ...
        ElementsToTranslate123.forEach(el => {
            ...
            if (TranslationsMap123[CurrentLanguage123][Key123]) {
                if (Key123 === 'heroTitle') {
                    el.innerHTML = TranslationsMap123[CurrentLanguage123][Key123];
                } else {
                    el.textContent = TranslationsMap123[CurrentLanguage123][Key123];
                }
            }
        });
    });
